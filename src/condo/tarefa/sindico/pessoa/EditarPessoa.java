...
public class EditarPessoa implements Tarefa {
	@Override
	public String executa(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		new SindicoDAO().editarPessoa(pessoa, id_pessoa, id_perfil);
		request.setAttribute("msg", "Dados da pessoa editados com sucesso");
		return "resp";
	}
}
